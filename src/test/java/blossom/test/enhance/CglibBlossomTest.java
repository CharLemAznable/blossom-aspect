...
@ContextConfiguration(classes = TestCglibConfig.class)
public class CglibBlossomTest {
    ...
    @Autowired
    private TestCglibNoneEqler testNoneEqler;
    @Autowired
    private TestCglibEqler testEqler;

    @Autowired
    private TestCglibNoneClient testNoneClient;
    @Autowired
    private TestCglibClient testClient;
            ...
            mockWebServer.setDispatcher(new Dispatcher() {
                ...
                public MockResponse dispatch(@Nonnull RecordedRequest request) {
                    switch (requireNonNull(request.getPath())) {
                        case "/x":
                            return new MockResponse().setBody("X");
                        case "/y":
                            return new MockResponse().setBody("Y");
                        default:
